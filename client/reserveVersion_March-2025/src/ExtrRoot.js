...
function ExtrRoot({score, setScore, totalScore,setTotalScore,mssg, setMessage}) {
...
return (
    ...
    <div >
     ...
     <mymath>  z = -{b}y² - {c}x + {d}y + y√x  </mymath>
